...
const praynow =  (e,timezone , prayerMethod, asrMethod) => {
              ...
              console.log(enddate.isValid(),"777777777777777777")
...
e = {latitude:17.3850,longitude:78.4867}
const timezone = geoTz(e.latitude,e.longitude)
something = praynow(e,timezone,1,1)
console.log(something , "00000000000000000")